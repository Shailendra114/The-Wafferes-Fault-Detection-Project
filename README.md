...
This Project is about wafers faults detection in a production based industry Based On various Sensors data so that they can replace that wafer just by stopping production line in a particular section of the industry as it will reduce time and yes it will be more profitable for company.
